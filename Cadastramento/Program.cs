    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.WriteLine(listaPessoa.Count());
                ...
                switch (opcao)
                {
                    case "01":
                        ...
                        listaPessoa.Add(new Cadastros(nome, apelido, nascimento,(float.Parse (altura)), id));
                    ...
                    case "02":
                        ...
                        if (alter != null)
                        {
                            ...
                            Console.WriteLine($" Nascimento:{alter.Nascimento}");
                            Console.WriteLine($" Altura:{alter.Altura}");
                    ...
                    case "03":
                        ...
                        if (excluirID != null)
                        {
                            ...
                            Console.WriteLine($"Altura: {exclu.Nascimento} ");
                            Console.WriteLine($" Nascimento: {exclu.Altura} ");
                    ...
                    case "04":
                        ...
                        foreach(Cadastros listar in listaPessoa)
                        {
                            ...
                            Console.WriteLine($" Nascimento: {listar.Nascimento} ");
                            Console.WriteLine($" Altura: {listar.Altura} ");
                    ...
                    case "05":
                        ...
                        if (pesq != null)
                        {
                            ...
                            Console.WriteLine($" Nascimento: {pesq.Nascimento} ");
